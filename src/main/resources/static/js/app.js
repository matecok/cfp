!function (a) {
    ...
    function d(t) {
        document.getElementById("header-lang-img") && ("en" == t ? document.getElementById("header-lang-img").src = "/images/flags/us.jpg" : "sp" == t ? document.getElementById("header-lang-img").src = "/images/flags/spain.jpg" : "gr" == t ? document.getElementById("header-lang-img").src = "/images/flags/germany.jpg" : "it" == t ? document.getElementById("header-lang-img").src = "/images/flags/italy.jpg" : "ru" == t && (document.getElementById("header-lang-img").src = "/images/flags/russia.jpg"), localStorage.setItem("language", t), null == (o = localStorage.getItem("language")) && d(r), a.getJSON("/lang/" + o + ".json", function (t) {
    ...
    }), document.addEventListener("fullscreenchange", u), document.addEventListener("webkitfullscreenchange", u), document.addEventListener("mozfullscreenchange", u), function () {
    ...
    }), window.sessionStorage && ((t = sessionStorage.getItem("is_visited")) ? a("#" + t).prop("checked", !0) : sessionStorage.setItem("is_visited", "layout-ltr")), null != o && o !== r && d(o), a(".language").on("click", function (t) {
